 ...
 *         &lt;element ref="{http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul}row"/>
 *       &lt;/choice>
...
@XmlType(name = "rowsElementType", propOrder = {
    "row"
})
public class RowsElementType {

    protected List<BoxElementType> row;
     ...
     * 
     */
    public List<BoxElementType> getRow() {
        if (row == null) {
            row = new ArrayList<BoxElementType>();
        }
        return this.row;
    }
