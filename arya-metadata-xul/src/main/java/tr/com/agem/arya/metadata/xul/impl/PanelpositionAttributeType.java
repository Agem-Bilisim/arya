...
/**
 * <p>Java class for panelpositionAttributeType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="panelpositionAttributeType">
 ...
 * 
 */
@XmlType(name = "panelpositionAttributeType")
@XmlEnum
public enum PanelpositionAttributeType {
    ...
    PanelpositionAttributeType(String v) {
        value = v;
    }
    ...
    public static PanelpositionAttributeType fromValue(String v) {
        for (PanelpositionAttributeType c: PanelpositionAttributeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
