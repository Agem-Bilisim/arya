...
/**
 * <p>Java class for querysetElementType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="querysetElementType">
 *   &lt;complexContent>
...
@XmlType(name = "querysetElementType", propOrder = {
    "queryOrRuleOrAction"
})
public class QuerysetElementType {

    @XmlElements({
        @XmlElement(name = "query", type = QueryElementType.class),
        @XmlElement(name = "rule", type = RuleElementType.class),
        @XmlElement(name = "action", type = ActionElementType.class)
    })
    protected List<Object> queryOrRuleOrAction;
    ...
    /**
     * Gets the value of the queryOrRuleOrAction property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the queryOrRuleOrAction property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getQueryOrRuleOrAction().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getQueryOrRuleOrAction() {
        if (queryOrRuleOrAction == null) {
            queryOrRuleOrAction = new ArrayList<Object>();
        }
        return this.queryOrRuleOrAction;
    }
