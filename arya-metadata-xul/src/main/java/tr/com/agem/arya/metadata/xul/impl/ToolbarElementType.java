...
public class ToolbarElementType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "toolbarspacer", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "toolbarspring", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "toolbarseparator", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "toolbarpalette", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "toolbargrippy", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "toolbaritem", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "toolbarbutton", type = JAXBElement.class, required = false)
    })
