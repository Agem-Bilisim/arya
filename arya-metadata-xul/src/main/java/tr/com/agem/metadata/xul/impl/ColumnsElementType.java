 ...
 *         &lt;element ref="{http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul}column"/>
 *       &lt;/choice>
...
@XmlType(name = "columnsElementType", propOrder = {
    "column"
})
public class ColumnsElementType {

    protected List<BoxElementType> column;
     ...
     * 
     */
    public List<BoxElementType> getColumn() {
        if (column == null) {
            column = new ArrayList<BoxElementType>();
        }
        return this.column;
    }
