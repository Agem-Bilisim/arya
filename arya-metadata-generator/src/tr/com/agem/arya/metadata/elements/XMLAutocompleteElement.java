...
public class XMLAutocompleteElement implements XMLElement {
	...
	public String xml(String property, FormAttribute formAttrAnn, boolean generateRandomVal) {
		...
		xml.append(" onChange=\"autocomplete(\"")
			.append(formAttrAnn.acUrl()).append("\", \"")
			.append(formAttrAnn.acParameterName()).append("\", ")
			.append(formAttrAnn.acPageSize()).append(", \"")
			.append(formAttrAnn.acCallbackJSFunc()).append("\")\"");
