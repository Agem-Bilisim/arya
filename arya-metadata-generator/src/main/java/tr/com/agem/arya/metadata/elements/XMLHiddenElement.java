...
public class XMLHiddenElement implements XMLElement {
	...
	public String xml(String property, FormAttribute formAttrAnn, boolean generateRandomVal) {
		...
		if (formAttrAnn.label() != null && !formAttrAnn.label().isEmpty()) {
			xml.append("\t\t<label visible=\"false\" id=\"").append(property).append("lbl").append("\" value=\"").append(formAttrAnn.label()).append("\" />\n");
		}
		xml.append("\t\t<textbox visible=\"false\" type=\"text\" id=\"").append(property).append("\" ");
