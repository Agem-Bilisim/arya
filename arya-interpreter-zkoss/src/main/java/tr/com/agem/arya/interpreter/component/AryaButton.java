...
public class AryaButton extends Button implements IAryaComponentProperty {
	...
	public AryaButton(Object parent, final AryaWindow aryaWindow, Attributes attributes) {
		super();
